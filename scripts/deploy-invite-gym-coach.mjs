...
const PUBLIC_URL = `https://${PROJECT_REF}.supabase.co/functions/v1/invite-gym-coach`;
...
function main() {
  ...
  console.log('✓ Edge Function invite-gym-coach desplegada');
  console.log(PUBLIC_URL);
  console.log('');
  console.log('Opcional: configura RESEND_API_KEY y WELCOME_EMAIL_FROM en Supabase → Edge Functions → Secrets');
  console.log('para enviar el correo de acceso al entrenador.');
}
