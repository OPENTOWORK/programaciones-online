...
export function PersonalizedPlanContent({ content }: PersonalizedPlanContentProps) {
  ...
  return (
    <View style={styles.wrap}>
      ...
      {main.trim() ? (
        <WorkoutSection title="Parte principal" content={main} icon="main" variant="featured" />
      ) : null}
